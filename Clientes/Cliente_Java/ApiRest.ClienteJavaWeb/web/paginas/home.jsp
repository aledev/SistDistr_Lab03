...
<mp:home-master>
    ...
    <jsp:body>
        <p>Bienvenido(a): <b>${sessionScope.currentUser.GetNombreCompleto()}</b>, al <u>Sistema Lab03 Web</u> :D!!</p>
        <br/>
        ...
        <p>Por cualquier referencia al c&oacute;digo fuente, dir&iacute;gete a la siguiente p&aacute;gina web: 
            <a href="https://github.com/aledev/SistDistr_Lab03" target="_blank">github.com/aledev/SistDistr_Lab03</a></p>
    </jsp:body>
</mp:home-master>
