...
<mp:home-master>
    ...
    <jsp:attribute name="pageSubtitle">
     ...
     <jsp:attribute name="breadcrumb">
         <ul class="breadcrumb">
             <li>Home</li> <li>Mantenedores</li> <li>Finanzas</li> <li>Editar</li>
         </ul>
    </jsp:attribute>
    <jsp:body>
        <form id="formNuevaFinanza" action="FinanzaController" method="post">
        <input type="hidden" name="action" value="guardarEditar">
        <input type="hidden" name="_id" value="${requestScope['finanzaObj'].get_Id()}">
        <input type="hidden" name="id" value="${requestScope['finanzaObj'].getId()}">
                         ...
                         <div class="form-group">
                             ...
                             <div class="col-sm-10">
                                 <input type="text" class="form-control" id="txtNombre" name="nombrePersona" 
                                        ...
                                        value="${requestScope['finanzaObj'].getNombrePersona()}">
                             </div>  
                         </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-md-8">
                         <div class="form-group">
                             ...
                             <div class="col-sm-10">
                                 ...
                                 value="${requestScope['finanzaObj'].getFchMovimiento()}">
                             </div>
                         </div>
                    </div>
                    <div class="col-xs-6 col-md-4">
                         ...
                         <div class="form-group">
                             ...
                             <div class="col-sm-10">
                                 <input type="number" class="form-control" id="txtSaldoMovimiento" name="saldoMovimiento" 
                                       ...
                                       value="${requestScope['finanzaObj'].getSaldoMovimiento()}">
                             </div>
                         </div>
                    </div>
                    <div class="col-xs-6 col-md-4">
