...
<mp:home-master>
    ...
    <jsp:attribute name="pageSubtitle">
     ...
     <jsp:attribute name="breadcrumb">
         <ul class="breadcrumb">
             <li>Home</li> <li>Mantenedores</li> <li>Recursos Humanos</li> <li>Editar</li>
         </ul>
    </jsp:attribute>
    <jsp:body>
        <form id="formNuevoRRHH" action="RrhhController" method="post">
        <input type="hidden" name="action" value="guardarEditar">
        <input type="hidden" name="id" value="${requestScope['rrhhObj'].GetId()}">
                         ...
                         <div class="form-group">
                             ...
                             <div class="col-sm-10">
                                 <input type="text" class="form-control" id="txtNombre" name="nombre" 
                                     ...
                                     value="${requestScope['rrhhObj'].GetNombrePersona()}">
                             </div>  
                         </div>
                    </div>
                         ...
                         <div class="form-group">
                             ...
                             <div class="col-sm-10">
                                <input type="text" class="form-control" id="txtDireccion" name="direccion" 
                                 required="required" placeholder="Dirección" maxlength="100" value="${requestScope['rrhhObj'].GetDireccion()}">
                             </div>
                         </div>
                    </div>
                    <div class="col-xs-6 col-md-4">
                         ...
                         <div class="form-group">
                             ...
                             <div class="col-sm-10">
                                <input type="text" class="form-control" id="txtComuna" name="comuna" 
                                 required="required" placeholder="Comuna" maxlength="50" value="${requestScope['rrhhObj'].GetComuna()}">
                             </div>
                         </div>
                    </div>
                    <div class="col-xs-6 col-md-4">
                         ...
                         <div class="form-group">
                             ...
                             <div class="col-sm-10">
                                <input type="text" class="form-control" id="txtEmail" name="email" 
                                       required="required" placeholder="Email" maxlength="100" value="${requestScope['rrhhObj'].GetEmail()}">
                             </div>
                         </div>
                    </div>
                    <div class="col-xs-6 col-md-4">
                         ...
                         <div class="form-group">
                             ...
                             <div class="col-sm-10">
                                <input type="text" class="form-control" id="txtTelefono" name="telefono" 
                                       required="required" placeholder="Teléfono" maxlength="25" value="${requestScope['rrhhObj'].GetTelefono()}">
                             </div>
                         </div>
                    </div>
                    <div class="col-xs-6 col-md-4">
                    ...
                    <div class="col-xs-12 col-md-8">
                         <div class="form-group">
                             ...
                             <div class="col-sm-10">
                                 ...
                                 required="required" placeholder="Fecha Nacimiento" value="${requestScope['rrhhObj'].GetFchNacimiento()}">
                             </div>
                         </div>
                    </div>
                    <div class="col-xs-6 col-md-4">
                         ...
                         <div class="form-group">
                             ...
                             <div class="col-sm-10">
                               <input type="date" class="form-control" id="txtFchContrato" name="fchContrato" 
                                 required="required" placeholder="Fecha Contrato" value="${requestScope['rrhhObj'].GetFchContrato()}">
                            </div>
                         </div>
                    </div>
                    <div class="col-xs-6 col-md-4">
